...
/*获取首页热门城市*/
export const cityHot = () => get('/v1/cities',{
  type: 'hot'
});
 ...
 * 获取首页所有城市
 */
export const cityGroup = () => get('/v1/cities',{
  type: 'group'
});
 ...
 * 获取当前所在城市
 */
export const currentCity = num => get('/v1/cities/'+ num);

/**
 * 获取搜索地址
 */
export const searchPlace = (value,cityid) => get('/v1/pois',{
  type: 'search',
  keyword: value,
  city_id: cityid
});
...
/**
 * 获取msite页面食品分类列表，github没给参数是因为毕竟仿写服务器没有处理参数
 */
